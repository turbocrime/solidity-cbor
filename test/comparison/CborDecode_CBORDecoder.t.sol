...
contract ComparisonTest is Test {
    ...
    function test_decodeFixedArray_CBORDecoder() public pure {
    ...
    function test_decodeFalse_CBORDecoder() public pure {
    ...
    function test_decodeTrue_CBORDecoder() public pure {
    ...
    function test_decodeNull_CBORDecoder() public pure {
    ...
    function test_decodeInteger_CBORDecoder() public pure {
    ...
    function test_decodeString_CBORDecoder() public pure {
    ...
    function test_decodeStringWithWeirdChar_CBORDecoder() public pure {
    ...
    function test_decodeArrayU8_CBORDecoder() public pure {
