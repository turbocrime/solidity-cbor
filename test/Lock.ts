...
describe("Lock", function () {
  ...
  async function deployOneYearLockFixture() {
    ...
    const lock = await hre.viem.deployContract("Lock", [unlockTime], { value: lockedAmount, });
    //const lock = (await hre.viem.deployContract("Lock", [unlockTime], { value: lockedAmount, })) GetContractReturnType<Lock$Type["abi"]>
